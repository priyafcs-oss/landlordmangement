...
- "bill": an invoice/bill for a property expense (council rates, water, strata, insurance, electricity, gas, land tax, or similar) stating an amount owed and a due date — i.e. something currently payable. This includes a land tax assessment notice from a state/territory revenue office (e.g. Revenue NSW, State Revenue Office).
